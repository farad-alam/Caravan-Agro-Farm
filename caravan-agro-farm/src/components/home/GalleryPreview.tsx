    ...
    <section className="py-24 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6">
          ...
          <Link 
            href="/gallery"
            className="inline-flex items-center gap-2 font-bangla font-semibold text-[var(--color-brand-green)] hover:text-[var(--color-brand-green-accent)] transition-colors group pb-2"
          >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-10">
          {images.map((img, idx) => (
            <div 
              key={idx} 
              className="relative overflow-hidden group bg-gray-100 aspect-[4/5] shadow-lg rounded-tl-[80px] rounded-br-[80px] md:rounded-tl-[120px] md:rounded-br-[120px] rounded-tr-sm rounded-bl-sm"
            >
              <Image
                src={img.src}
                alt={img.alt}
